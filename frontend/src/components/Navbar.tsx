        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold tracking-tight">HashBazaar</span>
            </Link>
            ...
            <div className="hidden md:ml-10 md:flex md:space-x-8">
              ...
              {role === 1 && (
                <Link href="/merchant" className="text-foreground hover:text-primary transition-colors font-medium">
                  Merchant Dashboard
                </Link>
              )}
              {role === 2 && (
                <Link href="/agent" className="text-foreground hover:text-primary transition-colors font-medium">
                  Escrow Board
                </Link>
              )}
            </div>
